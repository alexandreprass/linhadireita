  ...
  return (
    <section className="mb-10">
      <Link
        ...
        className="group grid overflow-hidden rounded-3xl border border-white/10 bg-[#0f1520] shadow-2xl shadow-black/40 transition hover:border-[#009c3b]/40 md:grid-cols-2"
      >
        <div className="relative min-h-[260px] bg-zinc-900 md:min-h-[380px]">
          ...
          <span className="absolute left-4 top-4 rounded-full bg-[#009c3b] px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-white shadow-lg">
            Destaque
          </span>
        </div>
        <div className="flex flex-col justify-center gap-4 p-6 md:p-10">
          ...
          <span className="text-sm font-semibold text-[#009c3b] transition group-hover:text-[#ffdf00]">
